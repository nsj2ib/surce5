#    جميع الحقوق لمطوري سورس ايدوارد حصريا لهم فقط
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/SC_60"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب ايدوارد  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/SC_60")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("للحصول على رابط تنصيب راسل المطور  📺", "https://t.me/SC_60")],
                [Button.url("المطور  ❓", "https://t.me/SC_60")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @SC_60", alert=True)
