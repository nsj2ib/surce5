...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"**𓆝︙ قام مطورين السورس بتحديث القرش**\n𓆝︙ **التـغييرات\n** {changelog}"
    )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    jasme = await event.edit(
        "** 𓆝︙ تم تحديث سورس القرش بنجاح انتظر قليلا سوف نخبرك بعد اعادة التشغيل !**"
    )
...
async def upstream(event):
    ...
    event = await edit_or_reply(event, "**𓆝︙ يـتـم البـحـث عـن تـحديثـات سـورس القرش انـتـظـر**")
    ...
    if conf == "" and not force_update:
        ...
        return await event.respond(
            f"⌔ :  لتحديث سورس ايدوارد ارسل : `.تحديث الان` "
        )
    ...
    if conf == "الان":
        await event.edit("** 𓆝︙ جار تحـديـث سـورس ايدوارد انـتـظـر قـليـلا 🔨**")
