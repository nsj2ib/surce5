...
@jepiq.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}لستة قنواتي الرسمية [𝗧ُِٔ𝗢ٍَِ𝗢َِّ𝗟َٖ𝗦َ]<buttonurl:t.me/L_H_V> [𝚂𝙷𝙰𝚁𝙺]<buttonurl:t.me/L_H_V> ",
    },
)
async def _(event):
    ...
    if not markdown_note:
        return await edit_delete(event, "𓆜︙ يجب عليك وضع مسافـة لاستخدامها مع الامر ")
