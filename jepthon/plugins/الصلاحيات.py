...
async def _(event):  # sourcery no-metrics
    ...
    if not event.is_group:
        return await edit_delete(event, "𓆝︙ هذه ليست مجموعة لقفل بعض الصلاحيات")
    chat_per = (await event.get_chat()).default_banned_rights
    cat = base64.b64decode("YnkybDJvRG04WEpsT1RBeQ==")
    if input_str in (("bots", "commands", "email", "forward", "url")):
        update_lock(peer_id, input_str, True)
        await edit_or_reply(event, "𓆝︙ تـم قفل {} بنجـاح ✅".format(input_str))
    else:
        ...
        if input_str == "الدردشه":
            if msg:
                return await edit_delete(
                    event, "𓆝︙ المجموعه بالتأكيد مقفولة من الرسائل "
                )
            msg = True
            locktype = "الدردشه"
            ...
            if media:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من الوسائط ⌁"
                )
            media = True
            locktype = "الوسائط"
            ...
            if sticker:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من الملصقات ⌁"
                )
            sticker = True
            locktype = "الملصقات"
            ...
            if embed_link:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من الروابط ⌁"
                )
            embed_link = True
            locktype = "الروابط"
            ...
            if gif:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من المتحركه ⌁"
                )
            gif = True
            locktype = "المتحركه"
            ...
            if gamee:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من الالعاب ⌁"
                )
            gamee = True
            locktype = "الالعاب"
            ...
            if ainline:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من الانلاين ⌁"
                )
            ainline = True
            locktype = "الانلاين"
            ...
            if gpoll:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من ارسال التصويت ⌁"
                )
            gpoll = True
            locktype = "التصويت"
            ...
            if adduser:
                return await edit_delete(
                    event, "𓆝︙ المجمـوعة بالتأكـيد مقفولة من اضافه الاعضاء ⌁"
                )
            adduser = True
            locktype = "الاضافة"
            ...
            if cpin:
                return await edit_delete(
                    event,
                    "𓆝︙ المجمـوعة بالتأكـيد مقفولة من تثبيت الرسائل ⌁",
                )
            cpin = True
            locktype = "التثبيت"
            ...
            if changeinfo:
                return await edit_delete(
                    event,
                    "𓆝︙ المجمـوعة بالتأكـيد مقفولة من تغيير معلومات الدردشه ⌁",
                )
            changeinfo = True
            ...
            if input_str:
                return await edit_delete(
                    event, f"𓆝︙ هنالك خطأ في الامر : `{input_str}`", time=5
                )

            return await edit_or_reply(event, "𓆝︙ لا استطيع قفل شيء")
        try:
            cat = Get(cat)
        ...
        try:
            ...
            await edit_or_reply(event, f"𓆝︙ تـم قفـل  {locktype} بنجـاح ⌁ ")
...
async def _(event):  # sourcery no-metrics
    ...
    peer_id = event.chat_id
    if not event.is_group:
        return await edit_delete(event, "𓆝︙ هذه ليست مجموعة قفل بعض الصلاحيات")
    cat = base64.b64decode("YnkybDJvRG04WEpsT1RBeQ==")
    chat_per = (await event.get_chat()).default_banned_rights
    if input_str in (("bots", "commands", "email", "forward", "url")):
        update_lock(peer_id, input_str, False)
        await edit_or_reply(event, "𓆝︙ تـم فتح {} بنجـاح ✅".format(input_str))
    else:
        msg = chat_per.send_messages
        media = chat_per.send_media
        sticker = chat_per.send_stickers
        ...
        if input_str == "الدردشه":
            if not msg:
                return await edit_delete(
                    event, "𓆝︙ الدردشه مفتوحه في هذه المجموعه ⌁"
                )
            msg = False
            locktype = "الدردشه"
        elif input_str == "الوسائط":
            if not media:
                return await edit_delete(
                    event, "𓆝︙ ارسال الوسائط مسموح في هذه الدردشه"
                )
            media = False
            locktype = "الوسائط"
        elif input_str == "الملصقات":
            if not sticker:
                return await edit_delete(
                    event, "𓆝︙ ارسال المصقات مسموح في هذه الدردشه ⌁"
                )
            sticker = False
            locktype = "الملصقات"
        elif input_str == "الروابط":
            if not embed_link:
                return await edit_delete(
                    event, "𓆝︙ ارسال الروابط مسموح في هذه الدردشه ⌁"
                )
            embed_link = False
            locktype = "الروابط"
        elif input_str == "المتحركه":
            if not gif:
                return await edit_delete(
                    event, "𓆝︙ ارسال المتحركه مسموح في هذه الدردشه ⌁"
                )
            gif = False
            locktype = "المتحركه"
        elif input_str == "الالعاب":
            if not gamee:
                return await edit_delete(
                    event, "𓆝︙ ارسال الالعاب مسموح في هذه الدردشه ⌁"
                )
            gamee = False
            locktype = "الالعاب"
        elif input_str == "الانلاين":
            if not ainline:
                return await edit_delete(
                    event, "𓆝︙ ارسال الانلاين مسموح في هذه الدردشه ⌁"
                )
            ainline = False
            ...
            if not gpoll:
                return await edit_delete(
                    event, "𓆝︙ ارسال التصويت مسموح في هذه الدردشه ⌁ "
                )
            gpoll = False
            locktype = "التصويت"
        elif input_str == "الاضافة":
            if not adduser:
                return await edit_delete(
                    event, "𓆝︙ اضافة الاعضاء مسموح في هذه الدردشه ⌁"
                )
            adduser = False
            locktype = "الاضافة"
        elif input_str == "التثبيت":
            if not cpin:
                return await edit_delete(
                    event,
                    "𓆝︙ تثبيت الرسائل مسموح في هذه الدردشه ⌁",
                )
            cpin = False
            locktype = "التثبيت"
        elif input_str == "تغيير المعلومات":
            if not changeinfo:
                return await edit_delete(
                    event,
                    "𓆝︙ تغيير معلومات الدردشه مسموح في هذه الدردشه ⌁",
                )
            changeinfo = False
            locktype = "تغيير المعلومات"
        elif input_str == "الكل":
            ...
            if input_str:
                return await edit_delete(
                    event, f"𓆝︙ خطأ في فتح الامر : `{input_str}`", time=5
                )
        ...
        try:
            ...
            await edit_or_reply(event, f"𓆝︙ تـم فتـح  {locktype} بنجاح ⌁ ")
        except BaseException as e:
            return await edit_delete(
                event,
                f"𓆝︙ ليس لديك صلاحيات كافيه ??\n\n**خطأ:** `{str(e)}`",
                time=5,
            )
...
async def _(event):  # sourcery no-metrics
    ...
    if not current_db_locks:
        ...
        res = "𓆝︙ ملـف الاوامر مقدم من سورس القرش: \n"
    ...
    try:
        ...
        res += "\n𓆝︙ هذه الصلاحيات الموجوده في هذه الدردشه : \n\n"
        res += f" 𓆝︙ ارسال الرسائل: `{umsg}`\n"
        res += f" 𓆝︙ ارسال الوسائط: `{umedia}`\n"
        res += f" 𓆝︙ ارسال الملصقات: `{usticker}`\n"
        res += f" 𓆝︙ ارسال المتحركه: `{ugif}`\n"
        res += f" 𓆝︙ ارسال الروابط: `{uembed_link}`\n"
        res += f" 𓆝︙ ارسال الالعاب: `{ugamee}`\n"
        res += f" 𓆝︙ ارسال الانلاين: `{uainline}`\n"
        res += f" 𓆝︙ ارسال التصويت: `{ugpoll}`\n"
        res += f" 𓆝︙ اضافه الاعضاء: `{uadduser}`\n"
        res += f" 𓆝︙ تثبيت الرسائل: `{ucpin}`\n"
        res += f" 𓆝︙ تغيير معلومات الدردشه: `{uchangeinfo}`\n"
