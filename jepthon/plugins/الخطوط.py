...
async def btext(event):
    ...
    if not isbold:
        addgvar ("bold", "on")
        await edit_delete(event, "**𓆝︙ تم تفعيل خط الغامق بنجاح ✓**")
        return

    if isbold:
        delgvar("bold")
        await edit_delete(event, "**𓆝︙ تم اطفاء خط الغامق بنجاح ✓ **")
        return
...
async def btext(event):
    ...
    if not isramz:
        addgvar ("ramz", "on")
        await edit_delete(event, "**𓆝︙ تم تفعيل خط الرمز بنجاح ✓**")
        return

    if isramz:
        delgvar("ramz")
        await edit_delete(event, "**𓆝︙ تم اطفاء خط الرمز بنجاح ✓ **")
        return
