...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 5328713035:
            await edit_or_reply(
                event, "**𓆜︙ عـذرا لا استـطيع اخـتراق مـطوري اعـتذر او سيقـوم بتهـكيرك**"
            )
        else:
            event = await edit_or_reply(event, "يتـم الاختـراق ..")
            animation_chars = [
                "𓆜︙ تـم الربـط بسـيرفرات الـتهكير الخـاصة",
                "تـم تحـديد الضحـية",
                "**تهكيـر**... 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ",
                "**تهكيـر**... 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ",
                "**تهكيـر**... 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ",
        ...
        await edit_or_reply(
            event,
            "𓆜︙ لم يتـم التعـرف على المستـخدم",
