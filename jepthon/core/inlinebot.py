...
def main_menu():
    text = f"**- [مطور سـورس ايدوارد](https://t.me/SC_60)\
        \n المسـاعد\
        \n\
        \n◽ ايدوارد لـ {mention}**"
    buttons = [
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("jepiq"):
            buttons = [
                (
                    ...
                    Button.url(" 𝚂𝙷𝙰𝚁𝙺 UsᴇʀBoᴛ", "https://t.me/SC_60"),
                )
            ]
            ...
            result = builder.article(
                title="رسـالة تـرول من سـورس القرش 🧸♥",
            ...
            result = builder.article(
                title="همسـة سـرية من سـورس ايدوارد 🧸♥",
                text=f"فقـط {razan} هـو مـن يستـطيع مشـاهدتهـا !",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
            ...
            result = builder.article(
                title="رسـالة مخفيـة من سـورس ايدوارد 🧸♥",
                text=f"✖✖✖",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
        ...
        buttons = [
            (
                Button.url("مطور  السـورس ⚒️", "https://t.me/SC_60"),
                Button.url(
                    "للاستفسار 📬",
                    "https://t.me/SC_60",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "**[بـوت ايدوارد 🧸♥](https://t.me/SC_60)**\
            \n\
            \n❤ ايدوارد هـو بـوت بسـيط يدخـل الـى حسـابك لجعـلك تتحـكم به معـ اوامـر معينـة.\
            \n\
            \n**اذا كـنت تـرغب بتـنصيـب السـورس عـلى حسـابك ,\
            \n🐾 تعال الـى [راسل المطور ](https://t.me/SC_60)!**",
            "md",
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
